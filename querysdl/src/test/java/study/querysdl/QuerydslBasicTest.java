...
import study.querysdl.dto.MemberDto;
import study.querysdl.dto.QMemberDto;
...
public class QuerydslBasicTest {
    ...
    public void findDtoJPQL(){
        List<MemberDto> result = em.createQuery("select new study.querysdl.dto.MemberDto(m.username,m.age) " +
