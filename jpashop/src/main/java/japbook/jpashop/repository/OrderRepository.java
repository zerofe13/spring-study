...
//회원 이름 검색
    ...
    public List<SimpleOrderQueryDto> findOrderDtos() {
        ...
        return em.createQuery("select new japbook.jpashop.repository.SimpleOrderQueryDto(o.id, m.name, o.orderDate, o.status, d.address) from Order o join  o.member m"
